        ...
        <div class="product-card__image-wrap">
          ...
          <?php else: ?>
            <div class="product-card__image product-card__image--placeholder" aria-hidden="true">
              <?php
                $icons = ['velas' => '🕯️', 'resina' => '💎', 'sublimacion' => '🖨️',
                          'souvenirs' => '🎁', 'regalos' => '🎀', 'decoracion' => '🌿'];
  ...
  <div class="container">
    <div class="custom-section__inner">
      ...
      <div class="custom-section__image fade-in delay-2">
        ...
        <!--
          Reemplazar por imagen real:
          <img src="assets/images/about/proceso.jpg"
               alt="Proceso artesanal de Sol & Luna"
               loading="lazy">
        -->
      </div>
  ...
  <div class="container">
    <div class="about-inner">
      ...
      <div class="about-image fade-in">
        ...
        <!--
          Reemplazar por imagen real del proceso o espacio de trabajo:
          <img src="assets/images/about/sobre-nosotras.jpg"
               alt="Sol & Luna — espacio de trabajo artesanal"
               loading="lazy">
        -->
      </div>
      ...
      <div class="about-text fade-up delay-1">
        ...
        <h2 class="section-title">Sobre Sol &amp; Luna</h2>
...
<section class="contact-section section" id="contacto" aria-label="Contacto">
  <div class="container">
    ...
    <div class="section-header fade-up">
      ...
      <p class="section-subtitle">Estamos para ayudarte. Escribinos cuando quieras.</p>
    </div>

  ...
  <div class="container">
    <div class="footer-inner">
      ...
      <nav class="footer-nav" aria-label="Navegación del footer">
        <h3 class="footer-nav-title">Explorar</h3>
        <ul role="list">
      ...
      <div class="footer-social">
        <h3 class="footer-nav-title">Seguinos</h3>
        <a href="<?= INSTAGRAM_URL ?>"
           class="footer-social-link footer-social-link--instagram"
           target="_blank" rel="noopener noreferrer"
           aria-label="Ver Instagram de <?= SITE_NAME ?>">
    ...
    <p class="footer-copy">
      &copy; <?= date('Y') ?> <?= SITE_NAME ?> · Santa Fe Capital, Argentina
    </p>
  ...
  <a href="<?= whatsapp_link() ?>"
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-info">
        ...
        <span>Punto de encuentro o entrega a domicilio</span>
      </div>
